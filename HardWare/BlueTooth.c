...
void BlueTooth_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_0;//默认PB0是USART1_TX的复用
	GPIO_InitStructure.GPIO_Speed=GPIO_Speed_50MHz;
	GPIO_Init(GPIOB,&GPIO_InitStructure);
	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_IPU;//复用上拉输入模式
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_1;//默认PB1是USART1_RX的复用
	GPIO_InitStructure.GPIO_Speed=GPIO_Speed_50MHz;
	GPIO_Init(GPIOB,&GPIO_InitStructure);
	//蓝牙
	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_AF_PP;//复用推挽输出模式
...
void USART1_IRQHandler(void)
{
	if(USART_GetITStatus(USART1,USART_IT_RXNE)==SET)//如果接受到
	{
		...
		if(USART_ReceiveData(USART1)==0x44)//跳舞
		{
			Face_Mode=4;
			Face_Config();
			Action_Mode=14;
		}
		if(USART_ReceiveData(USART1)==0x45)//唱歌
		{
			Face_Mode=9;
			Face_Config();
			Action_Mode=9;
		}
		if(USART_ReceiveData(USART1)==0x46)//哈哈
		{
			Face_Mode=10;
			Face_Config();
		}
		if(USART_ReceiveData(USART1)==0x47)//无语
		{
			Face_Mode=11;
			Face_Config();
		}
		if(USART_ReceiveData(USART1)==0x48)//小声
		{
			Face_Mode=12;
			Face_Config();
		}
		if(USART_ReceiveData(USART1)==0x49)//大声
		{
			Face_Mode=13;
			Face_Config();
		}
		if(USART_ReceiveData(USART1)==0x50)//退出
		{
			Face_Mode=14;
			Face_Config();
		}
		if(USART_ReceiveData(USART1)==0x51)//睡觉
		{
			Face_Mode=0;
			Face_Config();
			Action_Mode=18;
		}
		if(USART_ReceiveData(USART1)==0x52)//伸懒腰
		{
			Face_Mode=15;
			Face_Config();
			Action_Mode=19;
		}
		if(USART_ReceiveData(USART1)==0x53)//后退拉伸
		{
			Face_Mode=15;
			Face_Config();
			Action_Mode=20;
		}
		if(USART_ReceiveData(USART1)==0x54)//撅屁
		{
			Action_Mode=17;
		}
...
void USART3_IRQHandler(void)
{
	if(USART_GetITStatus(USART3,USART_IT_RXNE)==SET)//如果接受到
	{
		...
		if(USART_ReceiveData(USART3)==0x44)//跳舞
		{
			Face_Mode=4;
			Face_Config();
			Action_Mode=14;
		}
		if(USART_ReceiveData(USART3)==0x45)//唱歌
		{
			Face_Mode=9;
			Face_Config();
			Action_Mode=9;
		}
		if(USART_ReceiveData(USART3)==0x46)//哈哈
		{
			Face_Mode=10;
			Face_Config();
		}
		if(USART_ReceiveData(USART3)==0x47)//无语
		{
			Face_Mode=11;
			Face_Config();
		}
		if(USART_ReceiveData(USART3)==0x48)//小声
		{
			Face_Mode=12;
			Face_Config();
		}
		if(USART_ReceiveData(USART3)==0x49)//大声
		{
			Face_Mode=13;
			Face_Config();
		}
		if(USART_ReceiveData(USART3)==0x50)//退出
		{
			Face_Mode=14;
			Face_Config();
		}
		if(USART_ReceiveData(USART3)==0x51)//睡觉
		{
			Face_Mode=0;
			Face_Config();
			Action_Mode=18;
		}
		if(USART_ReceiveData(USART3)==0x52)//伸懒腰
		{
			Face_Mode=15;
			Face_Config();
			Action_Mode=19;
		}
		if(USART_ReceiveData(USART3)==0x53)//后退拉伸
		{
			Face_Mode=15;
			Face_Config();
			Action_Mode=20;
		}
		if(USART_ReceiveData(USART3)==0x54)//撅屁
		{
			Action_Mode=17;
		}
